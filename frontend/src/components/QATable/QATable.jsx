...
const QATable = React.memo(({ 
  ...
  const handleRowClick = useCallback((intern, e) => {
    ...
    // For now, we don't have individual QA intern profile pages
    ...
    return (
      <div className={styles.emptyState}>
        ...
        <p className={styles.emptyText}>
          Start by adding your first QA intern to the system.
        </p>
      </div>
    );
  }
          ...
          <tbody className={styles.tbody}>
            {interns.map((intern) => (
              ...
              >
                ...
                <td className={styles.td}>
                  <span className={styles.skills}>{intern.skills}</span>
                </td>
                {isAdmin && (
